...
contextBridge.exposeInMainWorld("api", {
  ...
  listDashboardJobs: () => ipcRenderer.invoke("list-dashboard-jobs"),
  loadDashboardJob: (payload) => ipcRenderer.invoke("load-dashboard-job", payload),
  saveDashboardJob: (payload) => ipcRenderer.invoke("save-dashboard-job", payload),
  deleteDashboardJob: (payload) => ipcRenderer.invoke("delete-dashboard-job", payload),
